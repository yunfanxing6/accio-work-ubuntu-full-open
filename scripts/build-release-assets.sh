...
(
  cd "$DIST_DIR"
  sha256sum "accio-work_0.4.6_amd64.deb" "Accio-0.4.6-linux-x86_64.AppImage" "Accio-0.4.6-linux-x64-portable.tar.gz" > "SHA256SUMS.txt"
)

printf 'Built %s\n' "$DIST_DIR/Accio-0.4.6-linux-x86_64.AppImage"
